...
export default function JournalEntryForm({ onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-night-blue bg-opacity-70 rounded-2xl p-6 max-w-xl mx-auto shadow-lg backdrop-blur-sm">
      <label htmlFor="journal" className="block mb-3 text-lg text-star-yellow font-serif">
